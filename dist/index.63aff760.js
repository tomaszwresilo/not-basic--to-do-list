...
})({"9GS3s":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    function addElementToList() {
        if (shoppingInput.value === "") alert("Wpisz nazwę produktu!");
        else {
    ...
    removeList.addEventListener("click", (event)=>{
        event.preventDefault();
        while(shoppingList.firstChild)shoppingList.removeChild(shoppingList.firstChild);
    });
    shoppingInput.addEventListener("keypress", function(event) {
        if (event.key === "Enter") addElementToList();
    });
    shoppingList.addEventListener("click", (event)=>{
        if (event.target.style.textDecoration === "line-through") event.target.style.textDecoration = "";
        else event.target.style.textDecoration = "line-through";
    });
});

},{"./style.css":"dRy26"}],"dRy26":[function() {},{}]},["9GS3s","adjPd"], "adjPd", "parcelRequire94c2")
